...
export function MobileBottomNav({ onAddGoal, onAddTasbeeh }: MobileBottomNavProps) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50">
      <InstallBanner />
      <div className="flex justify-around items-center min-h-16 pb-safe-min pt-2 bg-background/40 backdrop-blur-xl backdrop-saturate-150 border-t border-border/50 shadow-[0_-1px_12px_rgba(0,0,0,0.06)]">
        ...
        <div className="flex items-center justify-center flex-1">
          <Popover open={menuOpen} onOpenChange={setMenuOpen}>
            ...
            <PopoverContent side="top" align="center" className="w-[calc(100vw-2rem)] p-2" sideOffset={12}>
              <button
